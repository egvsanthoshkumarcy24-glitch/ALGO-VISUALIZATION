    ...
    return (
        <div className="min-h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] font-sans selection:bg-[var(--color-accent-primary)] selection:text-white pb-20">
            ...
            <div className="relative pt-32 pb-20 px-6 overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[var(--color-accent-primary)] opacity-[0.03] blur-[120px] rounded-full pointer-events-none" />
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        <h1 className="text-6xl md:text-7xl font-extrabold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-br from-white via-gray-200 to-gray-500">
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProblems.map((problem) => (
                    ...
                    >
                        <Card
                            className="h-full flex flex-col group hover:border-[var(--color-accent-primary)]/50 transition-colors cursor-pointer relative overflow-hidden"
                            onClick={() => onSelectProblem(problem)}
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-transparent to-[var(--color-bg-tertiary)] opacity-0 group-hover:opacity-100 transition-opacity" />
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-auto text-xs text-[var(--color-text-secondary)] font-mono border-t border-[var(--color-border)] pt-4">
